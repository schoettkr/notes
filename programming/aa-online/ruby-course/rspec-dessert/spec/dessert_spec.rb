...
describe Dessert do
  ...
  subject(:dessert) { Dessert.new("Chocolate Pudding", 5, chef) }

  describe "#initialize" do
    it "sets a type" do
      expect(dessert.type).to eq("Chocolate Pudding")
    end
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect do
        Dessert.new("Vanilia Pudding", "10", chef)
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to include("John")
    end
  end
